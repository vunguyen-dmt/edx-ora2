...
class OpenAssessmentBlock(
    ...
    def reset_submission(self, data, suffix=""):  # pylint: disable=unused-argument
        ...
        """
        course_end = self.course.end if self.course else None
        if not allow_resubmission(self.config_data, self.workflow_data, self.submission_data.student_submission, course_end):
